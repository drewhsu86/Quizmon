...
class CompletedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create completed" do
    assert_difference('Completed.count') do
      post completeds_url, params: { completed: { question_id: @completed.question_id, user_id: @completed.user_id } }, as: :json
    end
  ...
  test "should update completed" do
    patch completed_url(@completed), params: { completed: { question_id: @completed.question_id, user_id: @completed.user_id } }, as: :json
    assert_response 200
  end
